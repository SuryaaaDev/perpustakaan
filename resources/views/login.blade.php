...
<body>
    <div class="mx-auto max-w-screen-sm px-4 py-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-lg">
            ...
            <form action="{{ route('login.submit') }}" method="post" class="mt-6 mb-0 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                @csrf
                <p class="text-center text-lg font-medium">Login</p>
                @if (session('failed'))
                    <p class="text-center text-red-500 font-bold">{{ session('failed') }}</p>
                @endif
                <div>
