...
<?php endif; ?>
    ...
    <div class="flex py-10 justify-center items-center">
        <div class="max-w-xl p-16 rounded-xl shadow-xl bg-white">
            ...
            <form action="<?php echo e(route('book.store')); ?>" method="post" class="flex flex-col gap-5" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="checkbox" name="types[]" value="<?php echo e($type->id); ?>"
                            class="mx-2"><?php echo e($type->name); ?></input><br>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
