...
<body>
    <div class="mx-auto max-w-screen-sm px-4 py-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-lg">
            ...
            <form action="<?php echo e(route('registrasi.submit')); ?>" method="post" class="mt-6 mb-0 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\perpustakaan\resources\views/registrasi.blade.php ENDPATH**/ ?>