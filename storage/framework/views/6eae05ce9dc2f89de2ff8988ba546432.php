            ...
            <div class="md:flex md:items-center md:gap-12" x-data="{ open: false }">
                <nav aria-label="Global" class="hidden md:block">
                    <ul class="flex items-center gap-6 text-sm">
                        <li>
                            <a class="text-gray-500 transition hover:text-gray-500/75" href="/visitor"> Home </a>
                        </li>
...
<?php /**PATH C:\laragon\www\perpustakaan\resources\views/components/header-visit.blade.php ENDPATH**/ ?>